        ...
        <div class="col-sm-10">
                    ...
                    if ($file_error === 0) {
                        if ($file_size <= 2097152) {
                            ...
                            if (move_uploaded_file($file_tmp, $file_destination)) {
                                ...
                                $sql = "INSERT INTO news (title,content,categori_id,news_image_name) VALUES ('" . $title. "' , '" . $content. "' , '" . $catId . "' , '" . $file_destination."' )";
            ...
            <table class="table table-bordered">
                ...
                if (isset($_GET['delete'])) {
                    $index = $_GET['delete'];
//                    $sql="Select profile_img_name from lecturer WHERE id='$index'";
//                    $result=mysqli_query($dbConnection,$sql);
//                    $result = $result->fetch_assoc();
//                    chmod('/var/www/html/ACA/Homeworks/homework23/',666);
