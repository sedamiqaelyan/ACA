...
<div class="container">
    <div class="row">
        <div class="col-sm-12" style="text-align: center;">
            ...
            <h4 style="text-align: center;">Հարց 3 </h4>
            <p><h2 style="text-align: center;color: #2aabd2;">ԱՆՏԱՐԿՏԻԴԱՆ ՈՒՆԻ 0
                ՄՇՏԱԿԱՆ ԲՆԱԿԻՉ.</h2></p>
            ...
            <form method="post" action="page4.php">
                ...
                <input style="margin-left: 100px;" type="text" name="q3" title="Q3">
