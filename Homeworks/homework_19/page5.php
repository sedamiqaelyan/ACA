...
<div class="container">
    <div class="row">
        <div class="col-sm-12" style="text-align: center;">
            ...
            <h4 style="text-align: center;">Հարց 5 </h4>
            <p><h2 style="text-align: center;color: #2aabd2;">ՔԱՆԻ՞ ՕՎԿԻԱՆՈՍ ԿԱ ԵՐԿՐՈՒՄ.</h2></p>
            ...
            <form method="post" action="page6.php">
                ...
                <input style="margin-left: 100px;" type="text" name="q5" title="Q5">
