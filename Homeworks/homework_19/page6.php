...
<div class="container">
    <div class="row">
        <div class="col-sm-12" style="text-align: center;">
            ...
            <h4 style="text-align: center;">Հարց 6 </h4>
            <p><h2 style="text-align: center;color: #2aabd2;">ՔԱՆԻ՞ ՄԱՅՐՑԱՄԱՔ ԿԱ ԵՐԿԻՐ ՄՈԼՈՐԱԿՈՒՄ.</h2></p>
            ...
            <form method="post" action="rezults.php">
                ...
                <input style="margin-left: 100px;" type="text" name="q6" title="Q6">
